...
public class FileController {
    ...
    public String addFile(Authentication authentication, @RequestParam("file") MultipartFile file, @RequestParam("note") String note) throws IOException {
